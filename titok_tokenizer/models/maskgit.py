...
from titok_tokenizer.modules import BaseModel
from titok_tokenizer.modules import UViTBlock


class ImageBert(BaseModel, PyTorchModelHubMixin, tags=["arxiv:2406.07550", "image-generation"],
                repo_url="https://github.com/bytedance/1d-tokenizer", license="apache-2.0"):
...
if __name__ == "__main__":
    ...
    print(model)
    ckpt_path = r"D:\pyproject\awesome_tokenizer\titok_tokenizer\checkpoints\generator_titok_b64.bin"
