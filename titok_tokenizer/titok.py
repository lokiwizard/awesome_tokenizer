...
from titok_tokenizer.modules.quantizer import VectorQuantizer, DiagonalGaussianDistribution
...
class TiTok(BaseModel, PyTorchModelHubMixin, tags=["arxiv:2406.07550", "image-tokenization"],
