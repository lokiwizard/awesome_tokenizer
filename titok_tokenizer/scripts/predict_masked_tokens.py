...
def mask_tokens(input_tokens, mask_token_id=4096, mask_ratio=0.15):
    """
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        rec = titok_tokenizer.decode_tokens(predicted_masked_tokens.view(predicted_masked_tokens.shape[0], -1))
