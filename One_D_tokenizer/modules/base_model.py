...
class BaseModel(torch.nn.Module):
    ...
    def save_pretrained_weight(
        ...
        weights_name = "one_d_B_256_tokenizer.bin"
    ...
    def load_pretrained_weight(
        ...
        # file "one_d_B_256_tokenizer.bin" in this directory.
        elif os.path.isdir(pretrained_model_path):
            pretrained_model_path = os.path.join(pretrained_model_path, "one_d_B_256_tokenizer.bin")
            if os.path.isfile(pretrained_model_path):
                model_file = pretrained_model_path
            else:
