...
from titok import TiTok, PretrainedTokenizer
...
if __name__ == "__main__":
    ...
    qutized, info = tokenizer.encode(x)
    indices = info["min_encoding_indices"]
    print(indices.shape)
    rec = tokenizer.decode_tokens(indices, length=32)
    print(rec.shape)
